 ...
 *
 * @package
 * @copyright  Copyright (c) 2007-2015 Shop
...
//	}
	...
	$compile .= "\nBase::run();";
	file_put_contents(RUNCOREPATH,compress_code("<?php defined('BYshopJL') or exit('Access Invalid!');".$compile));
}
...
function compile($filename) {
    ...
    $content = str_ireplace("defined('BYshopJL') or exit('Access Invalid!')", '', $content);
