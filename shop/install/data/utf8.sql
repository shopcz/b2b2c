...
CREATE TABLE `#__store` (
  ...
  `store_baozh` tinyint(1) NOT NULL DEFAULT '0' COMMENT '保证服务状态，0关闭，1开启',
  `store_baozhopen` tinyint(1) NOT NULL DEFAULT '0' COMMENT '保证金缴纳状态，0未缴纳，1已缴纳',
  `store_baozhrmb` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '保证金数额',
  `store_qtian` tinyint(1) NOT NULL DEFAULT '0' COMMENT '七天退换服务状态，0关闭，1开启',
  `store_zhping` tinyint(1) NOT NULL DEFAULT '0' COMMENT '正品服务状态，0关闭，1开启',
  `store_erxiaoshi` tinyint(1) NOT NULL DEFAULT '0' COMMENT '2小时发货服务状态，0关闭，1开启',
  `store_tuihuo` tinyint(1) NOT NULL DEFAULT '0' COMMENT '退货保障服务状态，0关闭，1开启',
  `store_shiyong` tinyint(1) NOT NULL DEFAULT '0' COMMENT '试用服务状态，0关闭，1开启',
  `store_xiaoxie` tinyint(1) NOT NULL DEFAULT '0' COMMENT '消费保障服务状态，0关闭，1开启',
  `store_huodaofk` tinyint(1) NOT NULL DEFAULT '0' COMMENT '货到付款支持状态，0关闭，1开启',
  `store_shiti` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否实体店状态，0关闭，1开启',
...
('malbum_max_sum', '200'),
('md5_key', '8b80b78459e86c5552e157b9195b950b'),
...
('site_logo', 'logo.png'),
('site_name', 'ShopNC【B2B2C】电商系统sp1'),
...
INSERT INTO `#__adv_position` (`ap_id`, `ap_name`, `ap_intro`, `ap_class`, `ap_display`, `is_use`, `ap_width`, `ap_height`, `ap_price`, `adv_num`, `click_num`, `default_content`) VALUES (9, '首页底部通栏图片广告', '位于首页底部的通栏型图片广告', 0, 2, 1, 1200, 80, 100, 1, 0, '04418235791378401.jpg'),
(35, '积分列表页中部广告位', '积分列表页中部广告位', 0, 1, 1, 780, 254, 30, 0, 0, 'f448e48ee0deb06707480d46a2a360ae.gif'),
(37, '商品列表页左侧广告位', '商品列表页左侧广告位', 0, 1, 1, 200, 350, 100, 0, 0, '7a4832d109ee46fe7677c1d3c30e067f.gif');

INSERT INTO `#__adv` (`adv_id`, `ap_id`, `adv_title`, `adv_content`, `adv_start_date`, `adv_end_date`, `slide_sort`, `member_id`, `member_name`, `click_num`, `is_allow`, `buy_style`, `goldpay`) VALUES (15, 9, '首页通栏', 'a:2:{s:7:"adv_pic";s:21:"04418235791378401.jpg";s:11:"adv_pic_url";s:14:"www.shopnc.net";}', 1388505600, 1577721600, 0, 0, '', 0, 1, '', 0);
...
(35, 1, 'http://www.shopnc.net/', 1, 1, '火爆销售中', '火爆销售中<br />', 1389864697),
...
INSERT INTO `#__navigation` (`nav_id`, `nav_type`, `nav_title`, `nav_url`, `nav_location`, `nav_new_open`, `nav_sort`, `item_id`) VALUES(6, 0, '关于ShopNC', 'shop/index.php?act=article&article_id=22', 2, 0, 255, 0),
...
(13, '{name} - {sitename}', 'ShopNC,{sitename},{key}', 'ShopNC,{sitename},{description}', 'product'),
...
INSERT INTO `#__upload` (`upload_id`, `file_name`, `file_thumb`, `file_size`,`store_id`, `upload_type`, `upload_time`, `item_id`) VALUES
(175, 'help_store_04526250471329237.jpg', NULL, 93814, NULL, 2, 1399281047, 97),
(176, 'help_store_04526250486031950.jpg', NULL, 402109, NULL, 2, 1399281048, 97),
(177, 'help_store_04526250504192250.jpg', NULL, 248466, NULL, 2, 1399281050, 97),
(180, 'help_store_04526254603037325.jpg', NULL, 884442, NULL, 2, 1399281460, 99);
...
ALTER TABLE `#__mb_category` ADD PRIMARY KEY (`gc_id`);
...
ALTER TABLE `#__stat_ordergoods` ADD `order_amount` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '订单总价格' AFTER `payment_code`;
ALTER TABLE `#__stat_ordergoods` ADD `shipping_fee` decimal(10,2) unsigned DEFAULT '0.00' COMMENT '运费' AFTER `order_amount`;
ALTER TABLE `#__stat_ordergoods` ADD `evaluation_state` enum('0','1') DEFAULT '0' COMMENT '评价状态 0未评价，1已评价' AFTER `shipping_fee`;
ALTER TABLE `#__stat_ordergoods` ADD `refund_amount` decimal(10,2) DEFAULT '0.00' COMMENT '退款金额' AFTER `refund_state`;
...
INSERT INTO `#__adv_position` (`ap_id`, `ap_name`, `ap_intro`, `ap_class`, `ap_display`, `is_use`, `ap_width`, `ap_height`, `ap_price`, `adv_num`, `click_num`, `default_content`) VALUES(11, '首页焦点大图广告1', '位于首页焦点大图区', 0, 2, 1, 1920, 481, 100, 0, 0, '11.jpg');
INSERT INTO `#__adv_position` (`ap_id`, `ap_name`, `ap_intro`, `ap_class`, `ap_display`, `is_use`, `ap_width`, `ap_height`, `ap_price`, `adv_num`, `click_num`, `default_content`) VALUES(12, '首页焦点大图广告2', '位于首页焦点大图区', 0, 2, 1, 1920, 481, 100, 0, 0, '12.jpg');
INSERT INTO `#__adv_position` (`ap_id`, `ap_name`, `ap_intro`, `ap_class`, `ap_display`, `is_use`, `ap_width`, `ap_height`, `ap_price`, `adv_num`, `click_num`, `default_content`) VALUES(21, '首页焦点联动广告1', '位于首页焦点联动区', 0, 2, 1, 259, 180, 100, 0, 0, '21.jpg');
INSERT INTO `#__adv_position` (`ap_id`, `ap_name`, `ap_intro`, `ap_class`, `ap_display`, `is_use`, `ap_width`, `ap_height`, `ap_price`, `adv_num`, `click_num`, `default_content`) VALUES(22, '首页焦点联动广告2', '位于首页焦点联动区', 0, 2, 1, 259, 180, 100, 0, 0, '22.jpg');
INSERT INTO `#__adv_position` (`ap_id`, `ap_name`, `ap_intro`, `ap_class`, `ap_display`, `is_use`, `ap_width`, `ap_height`, `ap_price`, `adv_num`, `click_num`, `default_content`) VALUES(23, '首页焦点联动广告3', '位于首页焦点联动区', 0, 2, 1, 259, 180, 100, 0, 0, '23.jpg');
...
INSERT INTO `#__setting` (`name` ,`value`)VALUES ('delivery_isuse', '1');
INSERT INTO `#__setting` (`name` ,`value`)VALUES ('member_grade', 'a:4:{i:0;a:3:{s:5:"level";i:0;s:10:"level_name";s:2:"V0";s:9:"exppoints";i:0;}i:1;a:3:{s:5:"level";i:1;s:10:"level_name";s:2:"V1";s:9:"exppoints";i:1000;}i:2;a:3:{s:5:"level";i:2;s:10:"level_name";s:2:"V2";s:9:"exppoints";i:10000;}i:3;a:3:{s:5:"level";i:3;s:10:"level_name";s:2:"V3";s:9:"exppoints";i:20000;}}');
INSERT INTO `#__setting` (`name` ,`value`)VALUES ('exppoints_rule', 'a:4:{s:9:"exp_login";s:1:"5";s:12:"exp_comments";s:2:"10";s:13:"exp_orderrate";s:1:"1";s:12:"exp_ordermax";s:3:"500";}');
...
UPDATE `#__adv_position` SET `ap_display` = '2', `ap_width` = '900', `ap_height` = '368' WHERE `ap_id` =35;
UPDATE `#__adv_position` SET `ap_width` = '206', `ap_height` = '300' WHERE `ap_id` =37;
...
DROP TABLE `#__adv_click`;

DROP TABLE `#__live_area`;
DROP TABLE `#__live_class`;
DROP TABLE `#__live_groupbuy`;
DROP TABLE `#__live_order`;
DROP TABLE `#__live_order_pwd`;

DROP TABLE `#__mb_ad`;
DROP TABLE `#__mb_home`;
