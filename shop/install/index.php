...
$html_title = 'SHOPNC B2B2C官方安装程序';

$html_header = <<<EOF
<div class="header">
  <div class="layout">
    <div class="title">
      <h5>ShopNC B2B2C官方安装程序</h5>
      <h2>系统安装向导</h2>
    </div>
    <div class="version">版本: 2014.10.07.8256</div>
  </div>
</div>
...
<div class="footer">
  ...
  <h6>版权所有 2007-2014 &copy; <a href="http://www.shopnc.net" target="_blank">天津市网城天创科技有限责任公司</a>/<a href="http://www.shopnc.net" target="_blank">网店技术中心提供</a></h6>
...
function step3(&$install_error,&$install_recover){
    ...
    $db->query("INSERT INTO {$db_prefix}store (`store_id`,`store_name`,`grade_id`,`member_id`,`member_name`,`seller_name`,`store_state`,`store_time`,`is_own_shop`,`bind_all_gc`) VALUES ('1','{$store_name}','1','1','{$member_name}','{$seller_name}','1', '". time() ."','1','1')");
    ...
    $db->query("INSERT INTO {$db_pregix}store_extend (`store_id`)VALUES('1')");
